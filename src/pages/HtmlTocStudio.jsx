...
export default function App() {
  ...
  useEffect(() => {
    const sampleHtml = `
      <!DOCTYPE html>
      <html>
      <head><title>Sample Translator Document</title></head>
      <body>
        <section id="sec-intro">
          <h2>1. Introduction & Overview</h2>
          <p>Welcome to your translated document. You can customize this Table of Contents in the left sidebar.</p>
        </section>
        <section id="sec-grammar" dir="rtl">
          <h2>2. Arabic & Urdu Syntax Analysis</h2>
          <p>هذا النص لتجربة المحرر وإعادة ترتيب القوائم و الفئات الفرعية بكل سهولة.</p>
        </section>
        <section id="sec-bengali">
          <h2>3. Bengali Translation Output</h2>
          <p>এটি একটি পরীক্ষা মূলক অনুবাদ ফাইল। আপনি সহজেই এটিকে এডিট করতে পারবেন।</p>
        </section>
        <section id="sec-appendix">
          <h2>4. Appendix & Glossary</h2>
          <p>List of terms and vocabulary reference notes.</p>
        </section>
      </body>
      </html>
    `;
    setHtmlRaw(sampleHtml);
    parseHtmlContent(sampleHtml);

    // Inject Kalpurush Font stylesheet dynamically
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-900 text-slate-100 font-sans">
      ...
      <header className="h-14 bg-slate-950 border-b border-slate-800 px-4 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-medium shadow-sm transition-colors"
          >
        ...
        >
          <div className="p-3 border-b border-slate-800 flex items-center justify-between bg-slate-950/50">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded text-xs flex items-center gap-1 border border-slate-700"
          ...
          <div className="p-3 border-b border-slate-800 bg-slate-900/50">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 focus:border-blue-500 text-slate-200 text-xs px-2.5 py-1.5 rounded outline-none"
          ...
          <div className="p-2 border-t border-slate-800 bg-slate-950 text-[11px] text-slate-400 flex justify-between items-center">
          ...
          <div className="flex-1 overflow-y-auto p-6 flex justify-center">
            {sections.length > 0 ? (
                ...
                {activeTab === 'preview' &&
                  sections.map((sec) => (
                    <div
                      ...
                      className="bg-white text-slate-900 rounded-xl shadow-xl p-8 border border-slate-200"
                    >
              ...
              <div className="flex flex-col items-center justify-center h-full text-slate-500 text-center">
                <FileCode size={48} className="text-slate-700 mb-3" />
      ...
      {notification && (
        <div className="fixed bottom-4 right-4 bg-slate-800 text-slate-100 border border-slate-700 px-4 py-2.5 rounded-lg shadow-xl text-xs flex items-center gap-2 z-50">
